...
- - 1.1 [Синхронная версия проекта.](#11-синхронная-версия-проекта)
...
### 1.1 Синхронная версия проекта.
Данный проект полностью реализован в асинхронном виде, но, если кому интересно, то существует также версия данного проекта
с реализацией управлением базой данных посредством библиотеки ***SQLAlchemy***, в синхронном виде. Найти её можно в моём 
репозитории *github*, называется она [FastAPI_OAuth2](https://github.com/Paradox81ru/FastAPI_OAuth2).
